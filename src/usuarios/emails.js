...
class EmailRedefinicaoSenha extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Você pediu uma redefinição de sua senha. Use o token para trocar sua senha: ${token}`
    this.html = `<h1>Olá!</h1> Você pediu uma redefinição de sua senha. Use o token para trocar sua senha: ${token}`
  }
}
