...
/** 
 * A classe usuario é responsável por gerenciar todas as operações relacionadas a os usuários
*/
class Usuario {
  /**
   * O construtor recebe os dados de um usuário e os atribui a uma instância atual
 ...
 /**
  * @throws {InvalidArgumentError} - Esse erro ocorre quando um usuário tenta cadastrar um e-mail que já existe no nosso banco de dados!
  */
  async adiciona () {
